...
полноценной JWT-авторизацией и синхронизацией с FastAPI-бэкендом.

Архитектура и текущие ограничения подробно описаны в
[ARCHITECTURE.md](ARCHITECTURE.md).

## Особенности реализации

- **JWT Auth**: Автоматическое обновление токенов (Refresh Token flow) и перенаправление на вход при истечении сессии.
- **Offline First**: Работа без интернета с последующей синхронизацией данных (включая очередь отложенных удалений).
- **ObjectBox**: Высокопроизводительная локальная БД.
